...
def test_that_last_row_col_boundary_sudoku_is_not_a_valid_solution():
    is_valid = is_valid_solution_with_set_validator(almost_valid_sudoku_last_row_col_invalid())

    assert is_valid is False


def test_that_first_row_col_boundary_sudoku_is_not_a_valid_solution():
    is_valid = is_valid_solution_with_set_validator(almost_valid_sudoku_first_row_col_invalid())
